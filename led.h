...
/* Method 2 */
#define LED_RUN_DIAG_VCALL(me)   if ((me) && (me)->vptr && (me)->vptr->run_diagnostics) (*(me)->vptr->run_diagnostics)(me)
#define LED_GET_EFFI_VCALL(me)   ((me) && (me)->vptr && (me)->vptr->compute_efficiency) ? (*(me)->vptr->compute_efficiency)(me) : 0
