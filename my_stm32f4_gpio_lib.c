...
void __LIB_RCC_GPIOB_CLK_ENABLE(void){ RCC->AHB1ENR |= GPIOA_EN;}
void __LIB_RCC_GPIOC_CLK_ENABLE(void){ RCC->AHB1ENR |= GPIOA_EN;}
void __LIB_RCC_GPIOD_CLK_ENABLE(void){ RCC->AHB1ENR |= GPIOA_EN;}
void __LIB_RCC_GPIOE_CLK_ENABLE(void){ RCC->AHB1ENR |= GPIOA_EN;}
void __LIB_RCC_GPIOH_CLK_ENABLE(void){ RCC->AHB1ENR |= GPIOA_EN;}
