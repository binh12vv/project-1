...
#define RCC_BASE       (AHB1PERIPH_BASE + 0x3800U)  // Ðia chi dung cua RCC
...
typedef struct {
    ...
    uint32_t DUMMY6[2];
    __IO uint32_t AHB1PENR;
    __IO uint32_t AHB2PENR;
    uint32_t DUMMY7;
...
#define RCC ((RCC_TypeDef *)RCC_BASE)  // Ðia chi dúng cua RCC
